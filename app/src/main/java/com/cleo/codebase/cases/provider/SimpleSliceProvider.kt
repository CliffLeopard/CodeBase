...
class SimpleSliceProvider : SliceProvider() {
    /**
    ...
    /**
     * Converts URL to content URI (i.e. content://com.cleo.codebase.cases.provider...)
     */
    ...
    override fun onSlicePinned(sliceUri: Uri?) {
        ...
        // trigger SimpleSliceProvider#onBindSlice(Uri) again.
    }
