...
public class HookedKotlinLamCasesCompaniongtCase111Dump implements Opcodes {
    ...
    public static byte[] dump() throws Exception {
        ...
        cw.visit(52, ACC_FINAL + ACC_SUPER, "com/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1", "Lkotlin/jvm/internal/Lambda;Lkotlin/jvm/functions/Function1<Landroid/view/View;Lkotlin/Unit;>;", "kotlin/jvm/internal/Lambda", new String[]{"kotlin/jvm/functions/Function1"});

        cw.visitSource("HookedKotlinLamCases.kt", null);

        cw.visitOuterClass("com/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion", "gtCase11", "(Lkotlin/jvm/functions/Function1;)Lkotlin/jvm/functions/Function1;");
        ...
        {
            fv = cw.visitField(ACC_FINAL + ACC_SYNTHETIC, "$func", "Lkotlin/jvm/functions/Function1;", "Lkotlin/jvm/functions/Function1<Landroid/view/View;Lkotlin/Unit;>;", null);
            fv.visitEnd();
        }
        {
            mv = cw.visitMethod(0, "<init>", "(Lkotlin/jvm/functions/Function1;)V", "(Lkotlin/jvm/functions/Function1<-Landroid/view/View;Lkotlin/Unit;>;)V", null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitFieldInsn(PUTFIELD, "com/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1", "$func", "Lkotlin/jvm/functions/Function1;");
            mv.visitVarInsn(ALOAD, 0);
            ...
            Label l1 = new Label();
            mv.visitLabel(l1);
            mv.visitLocalVariable("this", "Lcom/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1;", null, l0, l1, 0);
            mv.visitLocalVariable("$func", "Lkotlin/jvm/functions/Function1;", null, l0, l1, 1);
            mv.visitMaxs(2, 2);
            mv.visitEnd();
        }
        {
            ...
            Label l2 = new Label();
            mv.visitLabel(l2);
            mv.visitLineNumber(213, l2);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "com/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1", "$func", "Lkotlin/jvm/functions/Function1;");
            mv.visitVarInsn(ALOAD, 1);
            mv.visitMethodInsn(INVOKEINTERFACE, "kotlin/jvm/functions/Function1", "invoke", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
            mv.visitInsn(POP);
            Label l3 = new Label();
            mv.visitLabel(l3);
            mv.visitLineNumber(214, l3);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitMethodInsn(INVOKESTATIC, "com/cleo/codebase/WrapperCenter", "wrapOnClickAfter", "(Landroid/view/View;)V", false);
            Label l4 = new Label();
            mv.visitLabel(l4);
            mv.visitLineNumber(215, l4);
            mv.visitInsn(RETURN);
            Label l5 = new Label();
            mv.visitLabel(l5);
            mv.visitLocalVariable("this", "Lcom/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1;", null, l0, l5, 0);
        ...
        }
        {
            ...
            Label l0 = new Label();
            mv.visitLabel(l0);
            mv.visitLineNumber(211, l0);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitTypeInsn(CHECKCAST, "android/view/View");
            mv.visitMethodInsn(INVOKEVIRTUAL, "com/cleo/codebase/cases/lam/HookedKotlinLamCases$Companion$gtCase11$1", "invoke", "(Landroid/view/View;)V", false);
